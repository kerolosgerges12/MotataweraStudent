...
public class StartQuizActivity extends AppCompatActivity {
    ...
    private void loadUI() {
        ...
        binding.quizQuestion.setText("Load First Question");
    ...
    private void onClick() {
        ...
        binding.quizNextBtn.setOnClickListener(v -> {
            ...
            if (currentQuestion == list.size()) {
                finish();
                checkradiobtn();
                Toast.makeText(StartQuizActivity.this, "Exam finish", Toast.LENGTH_SHORT).show();
    ...
    private void checkradiobtn() {
        ...
        if (currentQuestion == (list.size() - 1)) {
            binding.quizNextBtn.setText("Finish Exam");
        }
